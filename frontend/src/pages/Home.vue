    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Original taste from VietNam 😋</h3>
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy VietNam cuisine with
        ...
        <div class="home-category">
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/noodle-img.png" alt="">
                <h3>Noodle</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/rice-img.png" alt="">
                <h3>Rice</h3>
            </router-link>
        ...
        <div class="home-about">
            <div class="content">
                ...
                <p>Food to customers is always guaranteed of the best quality. Our dishes are made by chef Vũ (a 10
