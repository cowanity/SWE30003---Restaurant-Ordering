            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="sandwichFilterFoodBtn" name="sandwichFilterFoodBtn" class="menu-tab-item"
                            value="sandwich" @click="filterFoodBtn($event)" />
                        <input type="button" id="noodleFilterFoodBtn" name="noodleFilterFoodBtn" class="menu-tab-item"
                            value="noodle" @click="filterFoodBtn($event)" />
                        <input type="button" id="drinkFilterFoodBtn" name="riceFilterFoodBtn" class="menu-tab-item"
                            value="rice" @click="filterFoodBtn($event)" />
                        <input type="button" id="drinkFilterFoodBtn" name="soupFilterFoodBtn" class="menu-tab-item"
                            value="soup" @click="filterFoodBtn($event)" />
                        <input type="button" id="nachosFilterFoodBtn" name="saladFilterFoodBtn" class="menu-tab-item"
    ...
    methods: {
        ...
        filterFoodBtn: function (e) {
            ...
            if (this.foodObj.category != e.target.value && this.previousCategoryClicked != "") {
                this.previousCategoryClicked.target.style.background = "#FFAA33";
            }
